...
import {EventDailyAnalytics, EventDetailAnalytics, EventTotalAnalytics} from '../../models/analytics.model';
...
export class AnalyticsService {
  ...
  getEventDetailAnalytics(eventId: number) {

    return this.http.get<EventDetailAnalytics>(API_ENDPOINTS.GET_EVENT_DETAIL_ANALYTICS(eventId))
  }
}
